...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TruckDash — Food Truck Dashboard" },
      { property: "og:description", content: "Post today's spot, hours and menu — share a stunning flyer in one tap." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "TruckDash — Food Truck Dashboard" },
      { name: "twitter:description", content: "Post today's spot, hours and menu — share a stunning flyer in one tap." },
